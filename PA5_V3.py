...
if __name__ == "__main__":
    try:
        # Try common MT5 symbol variations
        symbols_to_try = ['BTCUSDm']
        for symbol in symbols_to_try:
            try:
                trader = EnhancedPriceActionTrader(symbol, risk_percent=1.3)
                trader.run_strategy()
                break
            except ValueError:
                continue
        ...
        print("3. Verify symbol exists in Market Watch")
